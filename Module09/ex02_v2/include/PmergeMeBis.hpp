...
/*   Updated: 2024/09/27 21:20:24 by lpaquatt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef std::vector <std::vector <unsigned int> > t_vectMatrix;
typedef std::vector <std::pair <t_vector, t_vector> > t_pairsVect;
...
class PmergeMe
{
	private:
		...
		t_vectMatrix	sortVectMat(t_vectMatrix &matrix);
