...
/*   Updated: 2024/08/08 13:09:24 by lpaquatt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		_hitPoints = 0;
		std::cout << RED << _name << " is dead! RIP little angel" << RESET << std::endl;
	}
}
...
void ClapTrap::displayStatus(void) const
{
	...
	std::cout << "--------------------------------" << std::endl;
	std::cout << LIGHT_BLUE << _name << " status:" << std::endl
